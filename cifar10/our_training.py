...
loss_dis = DiscriminativeLoss_forcing(num_classes = 10, dim = 128, delta_var=0.5, delta_dist=5.0)
...
torch.save(state, f'./saved_models/resnet18_sgd_train_ours_gaussian_noise_0.06_200_epochs')
